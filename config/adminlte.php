...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Dashboard',
            'route'  => 'home', // Asumsi route bernama 'home'
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Aturan Kewajiban',
                    'route'  => 'admin.requirement-rules.index',
        ...
        'Datatables' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '//cdn.datatables.net/2.3.2/js/dataTables.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '//cdn.datatables.net/2.3.2/js/dataTables.bootstrap4.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => '//cdn.datatables.net/2.3.2/css/dataTables.bootstrap4.min.css',
                ],
            ],
        ],       

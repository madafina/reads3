...
@section('title', 'Impor Residen')

@section('content_header')
    <h1 class="m-0 text-dark">Impor Data Residen</h1>
@stop
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul>
                        <li><code>nama</code> - Nama lengkap residen.</li>
                        <li><code>email</code> - Alamat email unik.</li>
                        <li><code>nim</code> - Nomor Induk Mahasiswa unik.</li>
                        <li><code>angkatan</code> - Tahun angkatan (contoh: 2024).</li>
                        <li><code>tahap</code> - Nama tahap saat ini (harus sama persis dengan yang ada di sistem, contoh: "Tahap I", "Tahap II").</li>
                    </ul>
                    <p>Password default untuk semua pengguna baru adalah: <strong>123456</strong></p>

                     <a href="{{ asset('dist/import_resident.xlsx') }}" class="btn btn-warning">Download sampel Excel</a>
